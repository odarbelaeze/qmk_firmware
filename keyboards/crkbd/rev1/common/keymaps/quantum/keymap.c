...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x6_3(
        ...
        KC_LGUI, LT(_RAISE ,KC_BSPC), KC_SPC, MT(MOD_INS, KC_SPC), LT(_LOWER,KC_ENT), KC_LALT
    ),
    [_LOWER] = LAYOUT_split_3x6_3(
        KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5,                 KC_6, KC_7, KC_8, KC_9, KC_0, KC_TRNS,
        KC_DEL,  KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,           KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MPLY, KC_PIPE,
        KC_LSFT, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,         KC_NO,   KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS,
    ...
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_LSFT, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,                KC_F12,  KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_BSLS,

        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(_ADJUST), KC_TRNS
    ),
    [_ADJUST] = LAYOUT_split_3x6_3(
        RESET, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, KC_NO, KC_NO, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_NO,
